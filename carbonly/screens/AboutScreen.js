    ...
    render() {
      return (
        ...
        <View style={styles.centerContainer}>
          ...
          <Text style={styles.baseText}>Eventually, we hope for Carbonly to be able to host small groups of friends to compete against each other to act in more sustainable ways, winning points from other people in their group for having more sustainable days, weeks, months, or even years!</Text>
